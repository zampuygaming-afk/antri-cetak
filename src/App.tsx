...
const CANON_MATERIALS = [
  ...
  { id: "CHROMO", label: "Chromo", short: "CHROMO" },
];
const ALL_MATERIAL_OPTIONS = [
  ...
  { id: "CHROMO", label: "CHROMO", group: "CANON" },
...
const FLEXI_OPTS: FinishingOpt[] = [
  ...
  { label: "Seaming Lipat Saja", route: ["GZ", "SEAM", "QC"], note: "Seaming Lipat Saja" },
...
function classifyMaterial(mat: string): "FLEXI" | "STICKER" | "CANON" {
  ...
  // CANON family - semua Art Paper + Vinyl + Transparan + CHROMO
  if (
